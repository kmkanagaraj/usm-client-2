...
export class DashboardController {
    ...
    */
    ...
    public getCpuUtilization(timeSlot: any) {
        this.serverService.getDashboardCpuUtilization(timeSlot.value).then((cpu_utilization) => {
    ...
    public getMemoryUtilization(timeSlot: any) {
        this.serverService.getDashboardMemoryUtilization(timeSlot.value).then((memory_utilization) => {
