...
export class ServerService {
    ...
    // **getListWithStatus**
    // **@returns** a promise with all servers with status.
    getListWithStatus(statusAndRole) {
        return this.rest.all('nodes?' + statusAndRole).getList<Node>().then(function(servers) {
