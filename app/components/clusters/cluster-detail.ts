...
export class ClusterDetailController {
    ...
    constructor(private qService: ng.IQService,
        ...
        this.clusterService.getClusterOverallUtilization(this.id).then((overall_utilization) => this.getOverallUtilization(overall_utilization));
    ...
    public getOverallUtilization(overall_utilization: any) {
