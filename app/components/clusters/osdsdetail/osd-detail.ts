...
export class OsdDetailController {
    ...
    constructor(private qService: ng.IQService,
        ...
        this.filterCollapse = { osd_status: false, pg_status: false, utilization: false}
        this.filteredOSD = {};
        ...
        if (Object.keys(this.paramsObject).length > 0) {
            if(this.paramsObject.active_filter !== undefined && this.paramsObject.filter_index !== undefined) {
                this.filterCollapse[this.paramsObject.active_filter] = true;
                this.activeFilter = this.paramsObject.active_filter;
                if(this.paramsObject.active_filter === 'osd_status') {
                    this.paramsObject.filter_index.forEach((index) => {
                        this.filterList.OSDStatus[index].checked = true;
                    });
                }else if(this.paramsObject.active_filter === 'pg_status') {
                    this.filterList.PGStatus[this.paramsObject.filter_index].checked = true;
                }else {
                    this.filterList.Utilization[this.paramsObject.filter_index].checked = true;
                }
            }
        }
