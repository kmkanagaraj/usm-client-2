...
export class ObjectStorageController {
    ...
    constructor(private $routeParams: ng.route.IRouteParamsService,
        ...
        private i18n: I18N) {
        this.types = [this.i18n._('Replicated'), this.i18n._('Erasure Coded')];
        this.type = this.i18n._('Replicated');
    ...
    public getReplicaCount() {
        if (this.type === this.i18n._('Replicated')) {
    ...
    public submit(): void {
        ...
        for (let pool of this.pools) {
            ...
            if (pool.type === this.i18n._('Replicated')) {
