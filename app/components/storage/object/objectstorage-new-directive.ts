 ...
 *
 * @example
 * <object-storage pool-with-rbd="blockdevice" prep-summary="blockdevice.prepareSummary()" rbd-list="blockdevice.rbdlist[]" pool-name="blockdevice.name"></object-storage>
 */
