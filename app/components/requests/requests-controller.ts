...
export class RequestsController {
    ...
    public getAbout() {
        this.sysSvc.getAboutDetails().then((aboutDet) => {
            this.configSvc.getConfig().then((config) => {
                this.about = {
                    prodName: aboutDet.ProductName,
                    prodVer: aboutDet.ProductVersion,
                    storageProvider: aboutDet.StorageProviderDetails,
                    dbsotware: aboutDet.DbSoftware,
                    dbVersion: aboutDet.DbSoftwareVersion,
