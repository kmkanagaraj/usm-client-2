...
export class HostOverviewController {
    ...
    constructor(private serverService: ServerService) {
            ...
            this.serverService.get(this.id).then((host:any) => {
                ...
                this.host = host;
                this.duration.utilizationSelectedTimeSlot = this.duration.timeSlots[0];
                this.duration.performanceSelectedTimeSlot = this.duration.timeSlots[0];
                this.duration.networkSelectedTimeSlot = this.duration.timeSlots[0];
