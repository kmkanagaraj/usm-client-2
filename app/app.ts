...
class USMApp {
    public initialize() {
        ...
        angular.module('usm-client', [
            ...
            // For uglify mangle
            .service('I18N', ['gettextCatalog', I18N])
...
/* tslint:disable */
                ...
                if (!gettextCatalog.strings[langUrl]) {
                    langUrl = langInfo.split('-')[0];
                    gettextCatalog.setCurrentLanguage(langUrl);
                    ret = gettextCatalog.loadRemote('./languages/' + langUrl + '.json');
                }
/* tslint:enable */
